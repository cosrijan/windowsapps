...
-   [**Ventoy**](https://sourceforge.net/projects/ventoy/) - Create flash drive without burning ISOs

#### Archiver
-   [**7-Zip**](https://www.7-zip.org/download.html/) - FOSS file archiver
-   [**WinRAR**](https://www.win-rar.com/download.html?&L=0) - Paid but GOAT

#### Documents
-   [**Foxit PDF reader**](https://www.foxit.com/downloads/#foxit-pdf-reader) - Better than Adobe
...
-   [**Proton VPN**](https://protonvpn.com/download-windows) - Best free VPN (requires login)

## Multimedia

-   [**EqualizerAPO**](https://sourceforge.net/projects/equalizerapo/files/latest/download) - Along with [AutoEQ](https://autoeq.app/)
